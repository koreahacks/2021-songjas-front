...
public class ProfileProjectAdapter extends RecyclerView.Adapter<ProfileProjectAdapter.ViewHolder>{
    Context context;
    ArrayList<ProfileProjectItem> items = new ArrayList<>();
    ...
    public ProfileProjectAdapter(Context context) {this.context = context; }

    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View  itemView  = inflater.inflate(R.layout.item_profile_project, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ProfileProjectItem item = items.get(position);
        holder.setItem(item);
    ...
    //addItem, items  메소드
    public void addItem(ProfileProjectItem item){
        items.add(item);
    }
    public void addItems(ArrayList<ProfileProjectItem> items){
        this.items = items;
    }

    //getItem 메소드
    public ProfileProjectItem getItem(int position){
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setItem(ProfileProjectItem item){
